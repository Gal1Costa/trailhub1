...
export default function Users() {
  ...
  // Only show empty state if there are truly no users in the system (total === 0)
  if (total === 0) return <EmptyState title="No users found" description="There are no users in the system." />;
